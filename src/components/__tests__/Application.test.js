...
describe("Application", () => {
  ...
  it("loads data, cancels an interview and increases the spots remaining for Monday by 1", async () => {
    ...
    await waitForElement(() => getByText(container, "Are you sure you want to delete appoinment?"));
  ...
  it("loads data, edits an interview and keeps the spots remaining for Monday the same", async () => {
    ...
    // 8. Wait until the element with the "Lydia Miller-Jones" button is displayed.
    await waitForElement(() => queryByText(appointment, "Lydia Miller-Jones"));
  ...
  it("shows the save error when failing to save an appointment", async () => {
    ...
    //Expect it to show a saving screen befor failing
    expect(getByText(appointment, "Saving")).toBeInTheDocument();

    await waitForElement(() => getByText(container, "Error"));
    //Error should occur then we can close the error
    ...
    // Check that the appointment is still in "Archie Cohen" name
